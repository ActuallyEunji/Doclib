...
<!-- 
   ...
   <br><br>
      ...
      <TABLE class="common" border="1" height="40">
   
         <TR>
            <TH align="center" class="common_th">회사명 </TH>
            <TH align="center" class="common_th">직원명</TH>   
            <TH align="center" class="common_th">결재순서</TH>   
         </TR>
         <TR>
            <TD align="center">${sessionScope.company_name} </TD>
            <TD align="center">${sessionScope.emp_name} (${sessionScope.jikup})</TD>
            <TD align="center">${sessionScope.company_emp_no}차 </TD>   
         </TR>
      </TABLE>
